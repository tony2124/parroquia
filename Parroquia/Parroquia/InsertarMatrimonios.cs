        ...
        private void guardarConfirBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {//Se guardan todos los campos en la base de datos
                    if (Bdatos.Insertar("insert into matrimonios(id_libro,num_hoja,num_partida,novio,novia,fecha_matrimonio,lugar_celebracion,testigo1,testigo2,asistente,anio)" +
