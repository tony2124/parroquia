...
class DataGridViewPrinter
{
    ...
    private void DrawHeader(Graphics g)
    {
        ...
        tamano_total = CurrentX + TheDataGridViewWidth + CurrentX - g.MeasureString("Parroquia: ___________________________________________________________ mes de _________________________ de ___________________",
            new Font("Times New Roman", 12, FontStyle.Bold)).Width;
        mitad = tamano_total / 2;

        g.DrawString("Parroquia: ___________________________________________________________ mes de _________________________ de ___________________",
            new Font("Times New Roman", 12, FontStyle.Bold),
